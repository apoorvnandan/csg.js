...
var materialRepo = new MaterialRepo(
        [new Material("#CHEBI_35441", "antiinfective drug","#440000", "simple", null, null),
        new Material("#CHEBI_35442", "antiparasitic drug", "#000044", "simple", null, null),
        new Material("#CHEBI_35440", "(1R,2S)-3-phenylcyclohexa-3,5-diene-1,2-diol", "#004400", "simple", null, null),
...
var lay = [
    new Layer("l:001", "L1", 1, materialRepo.materials[0]),
    new Layer("l:002", "L2", 1, materialRepo.materials[1]),
    new Layer("l:003", "L3", 1, materialRepo.materials[2])];

//1
var au = new AsymmetricUnit("au:001", "Gastrointestinal tract", lay, 1);
//2
...
var nodes = [
        new Node(0, 200, 100, null),
        new Node (1, 100, 200, null),
        new Node (2, 100, 400, tree),
        new Node (3, 300, 300, null)
    ],
    links = [
        new Link(nodes[0], nodes[1], au),
        new Link(nodes[1], nodes[2], au1),
        new Link(nodes[0], nodes[3], au2)
    ];
